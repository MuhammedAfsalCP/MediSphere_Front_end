...
const RegisterDoctor: React.FC = () => {
    ...
    const otpverify = useMutation({
        mutationFn: async (values: Partial<FormData>) => { 
            ...
            return AxiosInstance.post("/doctorregistersave/", formDataToSend, {
                headers: { "Content-Type": "multipart/form-data" },
            });
        },
        onSuccess: (data) => {
            ...
            <FormContainer>
                ...
                <form onSubmit={handleSubmit}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField label="Years of Experiance" name="years_of_experiance" type="number" fullWidth onChange={handleChange} required />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <TextField label="License Number" name="license_number" type="number" fullWidth onChange={handleChange} required />
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <TextField label="Consultation Fee" name="consultation_fee" type="number" fullWidth onChange={handleChange} required />
                        </Grid>
                        <Grid item xs={12}>
                            <FormControl fullWidth required>
                        ...
                        <Grid item xs={12}>
                            <FormControl fullWidth required>
                                ...
                                <TextField label="UPI Id Fee" name="upi_id" type="text" fullWidth onChange={handleChange} required />
                            </FormControl>
                        </Grid>
                        <Grid item xs={12} sm={6}>
                        ...
                        <Grid item xs={12} sm={6}>
                            <StyledTextField label="License Picture" type="file" fullWidth name="license_photo" onChange={handleFileChange} InputLabelProps={{ shrink: true }} required />
                        </Grid>
                    </Grid>
